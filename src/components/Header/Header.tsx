  ...
  return (
    <header className='header'>
        ...
        <nav className={mobileMenuOpen ? 'header__menu open' : 'header__menu'}>
            <Link className={mobileMenuOpen ? 'header__menu__link open' : 'header__menu__link'} to={PageRoutes.USERES_ORDERS}>Мои заказы</Link>
            <Link className={mobileMenuOpen ? 'header__menu__link open' : 'header__menu__link'} to={PageRoutes.THANKS}>Поблагодарить</Link>
            <Link className={mobileMenuOpen ? 'header__menu__link open' : 'header__menu__link'} to={PageRoutes.SHOP}>Магазин</Link>
            <Link className={mobileMenuOpen ? 'header__menu__link open' : 'header__menu__link'} to={PageRoutes.FAVOURITES}>Избранное</Link>
            <Dropdown menu={{ items: MenuItems }} className={mobileMenuOpen ? 'header__menu__link open' : 'header__menu__link'}>
        ...
        <div className='header__info'>
            ...
            <div className='header__info__left'>
                ...
                <div className='header__info__left__mobile-menu'>
                    <div className='header__info__left__mobile-menu__burger' onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
        				<span className={
                            mobileMenuOpen ? 'header__info__left__mobile-menu__burger__span open' 
                ...
                <div className='header__info__left__profile-info'>
                    ...
                    <div className='header__info__left__profile-info__shopping-cart'>
                        <Link className='header__info__left__profile-info__shopping-cart__link' to={PageRoutes.SHOPPING_CART}>
                        ...
                        <div className='header__info__left__profile-info__shopping-cart__section'>
                            <p className='header__info__left__profile-info__shopping-cart__section__quantity'>3</p>
                            <p className='header__info__left__profile-info__shopping-cart__section__price'>17.00</p>
                        </div>
                    </div>
                    ...
                    <Dropdown menu={{ items: ProfileItems }}>
                        <a onClick={(e) => e.preventDefault()}>
                            <div className='header__info__left__profile-info__user'>
                                ...
                                <span className='header__info__left__profile-info__user__p dropdown__p'>А.В. Петров</span>
                                <DownOutlined />
                            </div>
                        </a>
                    </Dropdown> 
